...
5. Run ./build.sh
6. Run build/flock2
7. For debugging enable CMAKE_BUILD_TYPE=Debug. A VSCode launch.json has been provided for convenience in debugging. We recommend to open VSCode to the \codes folder (not \codes\flock2), which gives you access to view & modify both \flock2 and \libmin.
